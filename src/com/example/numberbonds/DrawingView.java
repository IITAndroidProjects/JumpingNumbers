...
public class DrawingView extends View implements OnTouchListener {
	...
	public void check0()
	{
			...
			if(start<stop)
			{
				if((x1 >=(100+start*partition)-error && x1 <= (100+start*partition)+error) && (y1>=(2*height/3-30)-100 && y1<=(2*height/3-30)+100))
				{
					if((x2 >=(100+((start+1)*partition))-error && x2 <= (100+((start+1)*partition))+error) && (y2>=(2*height/3-30)-100 && y2<=(2*height/3-30)+100))
					{
